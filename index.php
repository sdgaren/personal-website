			...
			<div class="section" id="main">
				...
				<div class="textbox">
					...
					<p class="locationdaterange">
						<?php echo location_map(45.56,-122.69); ?>
					...
					<p>At Adidas, after successful roles taking over the eCommerce division's Business Performance Analytics team, I founded a back-of-house data science and development studio called Data Solutions, delivering end-to-end support for our business partners in the eCommerce and Retail divisions, Omnichannel Analytics, various business units, and our executive suite. Our work spans from construction of data sets and development of our data foundation, through automated reporting, dashboarding, and construction of tools, to advanced analytics, modeling, forecasting, and other data science projects. Our team ensures our internal clients and external business partners have immediate and reliable access to key infomation, work to elevate, contextualize, and prioritize key data from massive datasets for our partners, and provide critical insight into operational data to assist our partners in making data-driven decisions to steer the business.</p>
					<h2>Key Achievements</h2>
					<ul>
						<li>Management of a team of three analysts and developers focusing on in-market development of new tools and data capabilities, with special focus upon delivery of queryable data in domains previously inaccessable to end users. Successful data foundation deliveries include:
							<ul>
				...
				<div class="textbox">
					...
					<p class="locationdaterange">
						<?php echo location_map(47.65,-122.36); ?>
				...
				<a href="https://public.tableau.com/app/profile/samuel.garen/viz/ProductSalesDashboard_16465010297070/ProductSalesDashboard">
					<img class="sampleworkimage" src="samplework_productdashboard2.png" alt="Product Dashboard Thumbnail"/>
				</a>
				...
				<a href="https://github.com/sdgaren/personal-website">
					<img class="sampleworkimage" src="samplework_website2.png" alt="Screenshot of this website"/>
				</a>
				<div class="textboxsamplework">
				...
				<img class="awardimage" src="award_adidas.png" alt="Adidas Award"/></a>
				<div class="textboxsamplework">
					<p class="employer"><a href="http://www.adidas-group.com">Adidas AG</a></p>
					<ul>
				...
				<img class="awardimage" src="award_psu.png" alt="Portland State University Award"/></a>
				<div class="textboxsamplework">
					<p class="employer"><a href="http://www.pdx.edu">Portland State University</a></p>
					<ul>
